...
function sendDetails(data) {
  return `
    <div style="background: white; font-family: 'Roboto', sans-serif; width: 700px;"> <div style="padding: 0; margin: 0;"> <div style="border: 1px solid black; border-bottom: none; padding: 5px 15px; padding-bottom: 10px; background: #2065a8; color: white; border-top-left-radius: 15px; border-top-right-radius: 15px;"> <div> 
    ...
    <th style="text-align: end;">Valeur Restant</th> </tr>${getBanknotes(data)}<tr style="position: relative; top: 10px;"> <td style="overflow-wrap: anywhere; width: 15%;"></td><td style="overflow-wrap: anywhere; width: 25%;"></td><td style="text-align: end; font-weight: 600; overflow-wrap: anywhere; width: 30%;">Total restant</td><td style="text-align: end; font-weight: 600; overflow-wrap: anywhere; width: 30%;"> ${parseFloat(data.totalLeftBanknotesVal) ? parseFloat(data.totalLeftBanknotesVal).toFixed(2) : "0.00"}CHF</td></tr></table> </div><hr> <div> <table style="width: 100%"> <tr style="background:#7fb1e130"> <td style="overflow-wrap: anywhere;width: 45%;">Total <strong>Initial</strong></td><td style="overflow-wrap: anywhere;width: 40%;"></td><td style="overflow-wrap: anywhere;width: 15%; text-align:end;"> ${parseFloat(data.totalInitialBanknotesVal) ? parseFloat(data.totalInitialBanknotesVal).toFixed(2) : "0.00"}CHF</td>
    </tr><tr> <td style="overflow-wrap: anywhere;width: 45%;">Total <strong>Fonds de caisse</strong></td><td style="overflow-wrap: anywhere;width: 40%;"></td><td style="overflow-wrap: anywhere;width: 15%; text-align:end;"> ${parseFloat(data.totalFondDeCaisse) ? parseFloat(data.totalFondDeCaisse).toFixed(2) : "0.00"}CHF</td></tr><tr style="background:#7fb1e130"> <td style="overflow-wrap: anywhere;width: 45%;">Total site internet</td><td style="overflow-wrap: anywhere;width: 40%;"></td>
    ...
    <td style="font-weight: 600; overflow-wrap: anywhere;width: 45%;">Total paiement sans facture </td><td style="overflow-wrap: anywhere;width: 40%;"></td><td style="font-weight: 600; overflow-wrap: anywhere;width: 15%; text-align:end;"> ${parseFloat(data.nonFacturesTotal) ? parseFloat(data.nonFacturesTotal).toFixed(2) : "0.00"}CHF </td></tr>${getChargesRows(data.nonFacturesDetails)}</table> </div></div></div></div>
  `}
