...
function getBanknotes(data) {
  ...
  for (let idx = 0; idx < data.banknotesDetails.length; idx++) {
    ...
    toret += `<tr><td>${banknote.value} CHF</td><td style="text-align: end;">${banknote.initialVal ? banknote.initialVal.toFixed(2) : "0.00"} CHF</td><td style="text-align: end;">${banknote.finalVal ? banknote.finalVal.toFixed(2) : "0.00"} CHF</td></tr>`
  }
  return toret
}
